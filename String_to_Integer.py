...
"   42"  →  "42"
Just strip leading whitespace.

Step 2 — Check Sign
"-42"  →  sign = -1
"+42"  →  sign = +1
"42"   →  sign = +1 (default)
Move pointer forward after reading sign.

Step 3 — Read Digits Only
"1337c0d3"  →  read "1337", stop at 'c'
"words987"  →  read nothing, stop at 'w'
Stop as soon as you hit a non-digit character.
